...
<table class="color" id="activity_table">
    <tr>
        ...
        <th>分享量</th><th>点击数 </th><th>活动状态 </th><th>活动的真正结束时间</th>
...
<#assign paList=result.object.palist>
    <#if paList?size &gt; 0>    	
        ...
        <#assign joinCount=popularizeActivity.joinCount>
        <#assign clickCount=popularizeActivity.clickCount>
        <#if popularizeActivity.activityId == 1018>
        <#assign joinCount=128>
        <#assign clickCount=857>
        </#if>
        <#if popularizeActivity.activityId == 1021>
        <#assign joinCount=618>
        <#assign clickCount=1857>
        </#if>
        <#if popularizeActivity.activityId == 1023>
        <#assign joinCount=28>
        <#assign clickCount=57>
        </#if>
        <#if popularizeActivity.activityId == 1024>
        <#assign joinCount=135>
        <#assign clickCount=620>
        </#if>
           <tr>
             <td>
